      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="index" class="site_title"><i class="fa fa-paw"></i> <span>Admin Panel!</span></a>
          </div>
          ...
          <div class="profile clearfix">
            <div class="profile_pic">
              <img src="../../<?php echo $kullanicicek['kullanici_magazafoto'] ?>" alt="..." class="img-circle profile_img">
            </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
             ...
             <li><a href="kategori.php"><i class="fa fa-list"></i> Kategoriler </a></li>
              ...
              <li><a href="bloglar.php"><i class="fa fa-rss"></i> Bloglar </a></li>


             <li><a href="yorum.php"><i class="fa fa-comments"></i> Yorumlar </a></li>

             <li><a href="sikayet.php"><i class="fa fa-bullhorn"></i> Şikayetler </a></li>
