 ...
 <style type="text/css">
     #reklam{
        ...
        width: 811px;
                ...
                <!--- KULLANICI REKLAM RESİM ALANI BAŞLANGIÇ -->
                    <div class="single-banner">
                    <?php 
                    if (strlen($kullanicicek['kullanici_resim'])>0) {?>

                    <div ><img id="reklam"  src="<?php echo $kullanicicek['kullanici_resim']; ?>"></div>

                    <?php } else {?>

                    <img   src="https://via.placeholder.com/729x250/FFFFFF/?text=Reklam"  alt="reklam" class="img-responsive">
