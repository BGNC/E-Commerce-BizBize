...
$sosyalsor=$db->prepare('SELECT * FROM sosyal_medya WHERE kullanici_id=:id');
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 col-lg-pull-9 col-md-pull-8 col-sm-pull-8">
                <div class="fox-sidebar">
                    <div class="sidebar-item">
                        <div class="sidebar-item-inner">
                            ...
                            <ul class="sidebar-badges-item">
                                ...
                                <li><img src="img\profile\badges1.png" alt="Yıldız Üye" title="Classic Üye" class="img-responsive"></li>

                                <?php }  else if ($saycek['say']>9 and $saycek['say']<=99) {?>

                                <li><img src="img\profile\badges1.png" alt="Yıldız Üye" title="Classic  Üye" class="img-responsive"></li>
                                <li><img src="img\profile\badges2.png" alt="badges" title="Classic Plus Üye" class="img-responsive"></li>

                                <?php }  else if ($saycek['say']>99 and $saycek['say']<=999) {?>
                                <li><img src="img\profile\badges1.png" alt="Yıldız Üye" title="Classic Üye" class="img-responsive"></li>
                                <li><img src="img\profile\badges2.png" alt="badges" title="Classic Plus Üye" class="img-responsive"></li>
                                <li><img src="img\profile\badges3.png" alt="badges" title="Elite Üye" class="img-responsive"></li>
                                ...
                                <li><img src="img\profile\badges2.png" alt="badges" title="Classic Plus Üye" class="img-responsive"></li>
                                <li><img src="img\profile\badges3.png" alt="badges" title="Elite Üye" class="img-responsive"></li>
                                <li><img src="img\profile\badges4.png" alt="badges" title="Elite Plus Üye" class="img-responsive"></li>
                                ...
                                <li><img src="img\profile\badges3.png" alt="badges" title="Elite Üye" class="img-responsive"></li>
                                <li><img src="img\profile\badges4.png" alt="badges" title="Elite Plus Üye" class="img-responsive"></li>
                                <li><img src="img\profile\badges5.png" alt="badges" title="First Class Üye" class="img-responsive"></li>
                    ...
                    <ul class="social-default" >
                        <li><a href="<?php echo $sosyalcek['facebook'];?>"><i style="margin-top:5px;" class="fa fa-facebook" aria-hidden="true"></i></a></li>
                        <li><a href="<?php echo $sosyalcek['twitter'];?>"><i style="margin-top:5px;" class="fa fa-twitter" aria-hidden="true"></i></a></li>
                        <!--<li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>-->
                        <li><a href="<?php echo $sosyalcek['instagram'];?>"><i style="margin-top:5px;" class="fa fa-instagram" aria-hidden="true"></i></a></li>
                    </ul>           
