<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
	...
	<ul class="settings-title">
		...
		<li class="active"><a href="javascript:void(0)" ><b>BLOG İŞLEMLERİ</b></a></li>
		<li ><a href="blog-ekle" >Blog Yaz </a></li>
		<li ><a href="bloglarim" >Bloglarım</a></li>
		<li ><a href="sosyal" > Sosyal Medya </a></li>
	...
	<ul class="settings-title">
		...
		<li class="active"><a href="javascript:void(0)" ><b>MAĞAZA İŞLEMLERİ</b></a></li>
		 <li><a href="satici-<?=seo($kullanicicek['kullanici_ad']."-".$kullanicicek['kullanici_soyad'])."-".$kullanicicek['kullanici_id'] ?>" class="view-profile">Mağazamı Görüntüle</a></li>
