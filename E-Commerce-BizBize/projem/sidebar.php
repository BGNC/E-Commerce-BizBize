...
<div class="fox-sidebar">
    <div class="sidebar-item">
        <div class="sidebar-item-inner">
            <h3 class="sidebar-item-title"><span style="font-weight: bold;">Kategoriler</span></h3>
            <ul class="sidebar-categories-list">
             ...
             while($kategoricek=$kategorisor->fetch(PDO::FETCH_ASSOC)) { 
                ...
                <li><a style="font-size:16px;" href="kategoriler-<?=seo($kategoricek['kategori_ad'])."-".$kategoricek['kategori_id'] ?>"><?php echo $kategoricek['kategori_ad'] ?><span>(
