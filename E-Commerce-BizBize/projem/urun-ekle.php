...
<div class="settings-page-area bg-secondary section-space-bottom">
    <div class="container">
        ...
        <div class="row settings-wrapper">
            ...
            <form action="nedmin/netting/admin_islem.php" method="POST" enctype="multipart/form-data" class="form-horizontal" id="personal-info-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <textarea rows="15" cols="69.5"  class="ckeditor" id="editor1" name="urun_detay" placeholder="Ürün Açıklaması Giriniz."></textarea>
                                    </div>
                                </div>
