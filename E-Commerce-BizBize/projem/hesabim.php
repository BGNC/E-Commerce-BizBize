                    ...
                    <div class="tab-pane fade active in" id="Personal">
                        ...
                        <div class="personal-info inner-page-padding"> 
                         ...
                         <div class="form-group">
                            <label class="col-sm-3 control-label">Kayıtlı Mail</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" minlength="3" id="first-name" name="kullanici_ad" value="<?php echo $kullanicicek['kullanici_ad'] ?>" type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" minlength="1" name="kullanici_soyad" value="<?php echo $kullanicicek['kullanici_soyad'] ?>"  id="last-name" type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" required="" minlength="11" maxlength="11" name="kullanici_gsm" value="<?php echo $kullanicicek['kullanici_gsm'] ?>" id="company-name" type="text">
                            </div>
                        </div>
