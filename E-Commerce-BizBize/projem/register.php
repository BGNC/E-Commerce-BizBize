            ...
            <div class="registration-page-area bg-secondary section-space-bottom">
                ...
                <?php }
                 ?>
                        ...
                        <form id="personal-info-form" method="POST" action="nedmin/netting/kullanici.php">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">                                          
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="first-name" required="" minlength="2" placeholder="Adınızı Giriniz..." name="kullanici_ad" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">                                          
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">                                          
                                    <div class="form-group">
                                        ...
                                        <input type="password" id="first-name" minlength="6" required="" placeholder="Şifrenizi Giriniz.." name="kullanici_passwordone" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">                                          
                                    <div class="form-group">
                                        <label class="control-label" for="last-name">Şifreniz Tekrar *</label>
                                        <input type="password" id="last-name" minlength="6" required="" placeholder="Şifrenizi Tekrar Giriniz..." name="kullanici_passwordtwo" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                 ...
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                                           
                                    <div class="pLace-order">
                                        <button class="update-btn disabled" id="kaydet" type="submit" name="musterikaydet" >Gönder</button>
                                    </div>
                                </div>
                            </div> 
                        </form>                      
