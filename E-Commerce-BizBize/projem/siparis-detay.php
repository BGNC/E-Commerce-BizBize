                  ...
                  <div class="tab-pane fade active in" id="Personal">
                    ...
                    <div class="personal-info inner-page-padding"> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                         <input type="radio" name="yorum_puan" value="1"> ☆
                         <input type="radio" name="yorum_puan" value="2"> ☆☆
                         <input type="radio" name="yorum_puan" value="3"> ☆☆☆
                         <input type="radio" name="yorum_puan" value="4"> ☆☆☆☆
                         <input type="radio" name="yorum_puan" value="5"> ☆☆☆☆☆
                       </div>
                     </div>
