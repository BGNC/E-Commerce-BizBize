                ...
                <div class="settings-details tab-content">
                    <div class="tab-pane fade active in" id="Personal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" minlength="6" id="first-name" name="kullanici_eskipassword" placeholder="Eski Şifrenizi Giriniz" type="password">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" minlength="6"  id="first-name" name="kullanici_passwordone" placeholder="Şifrenizi Giriniz" type="password">
                            </div>
                        </div>
