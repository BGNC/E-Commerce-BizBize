...
$userkullanici_id=@$_SESSION['userkullanici_id'];
if ($fark>600) {
    ...
    $zamanguncelle=$db->prepare("UPDATE kullanici SET
        ...
        WHERE kullanici_id=$userkullanici_id");
                            ...
                            <div class="row">                         
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <ul class="profile-notification">     
                                        ...
                                        <li>
                                            <div class="notify-contact" ><span style="font-weight: bold;">Need help?</span> Send to Us A Message</div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="notify-message">
                                                <a href="#"><i style="padding-top: 10px;" class="fa fa-envelope-o" aria-hidden="true"></i><span>
                                             ...
                                             <ul>
                                                ...
                                                <li>
                                                    <div class="notify-message-info">
                                                        <div style="color:black !important" class="notify-message-subject">Yeni Mesaj Gelmedi.</div>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="notify-message-sign">
                                                        <a  href="mesaj-detay?mesaj_id=<?php echo $mesajcek['mesaj_id'] ?>&kullanici_gon=<?php echo $mesajcek['kullanici_gon'] ?>"><i style="padding-top: 10px;" style="color:orange !important" class="fa fa-envelope-o" aria-hidden="true"></i></a>
                                                    </div>
                                                </li>
                                        ...
                                        <div class="user-account-info">
                                            <div class="user-account-info-controler">
                                                <div class="user-account-img">
                                                    <a href="profil-resim-guncelle"><img style="border-radius: 30px;" width="32" height="32" class="img-responsive" src="<?php echo $kullanicicek['kullanici_magazafoto'] ?>" alt="Profil Resmi"></a>
                                                </div>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="bloglarim">Blog Bilgilerim</a></li>
